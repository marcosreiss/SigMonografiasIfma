...
namespace SigMonografiasIfma.Controllers
{
    public class ProfessorController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var professor = await _context.Orientadores
        ...
        public async Task<IActionResult> Create([Bind("Siap,Id,Nome,Email,Telefone,Cidade,Campus")] Professor professor)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var professor = await _context.Orientadores.FindAsync(id);
            if (professor == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Siap,Id,Nome,Email,Telefone,Cidade,Campus")] Professor professor)
        {
            if (id != professor.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            if (professor != null)
            {
                _context.Orientadores.Remove(professor);
            }
